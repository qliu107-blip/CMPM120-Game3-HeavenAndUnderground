class Platformer extends Phaser.Scene {
    ...
    init() {
        ...
        this.waterIDs = [33, 53, 73, 34, 54, 74];
    ...
    create() {
        ...
        this.coins.forEach(coin => coin.setScale(1.5));
        ...
        this.noticeUI = document.createElement("div");
        this.noticeUI.style.position = "absolute";
        this.noticeUI.style.left = "20px";
        this.noticeUI.style.top = "55px";
        this.noticeUI.style.color = "white";
        this.noticeUI.style.fontSize = "20px";
        this.noticeUI.style.fontFamily = "Arial";
        this.noticeUI.style.zIndex = "9999";
        this.noticeUI.style.textShadow = "2px 2px 4px black";
        this.noticeUI.innerHTML = "";
        document.body.appendChild(this.noticeUI);
    ...
    collectCoin(coin, points) {
        ...
        this.showFloatingPoints(coin.x, coin.y, points);
    ...
    saveRelive(flag) {
        ...
        this.showNotice("Respawn point saved!", 1000);
    }
    ...
    respawnPlayer() {
        ...
        this.showNotice("You died! Respawned at the flag.", 1200);
    ...
    showNotice(text, duration) {
        if (!this.noticeUI || this.gameOver) return;

        this.noticeUI.innerHTML = text;
    ...
    showFloatingPoints(x, y, points) {
        let pointText = this.add.text(x, y - 20, "+" + points, {
            fontFamily: "Arial",
            fontSize: "16px",
            color: "#ffff00",
            stroke: "#000000",
    ...
    checkWaterDeath() {
        ...
        if (tile && this.waterIDs.includes(tile.index)) {
            this.respawnPlayer();
        }
